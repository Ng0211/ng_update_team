  ...
  const ClubCard = ({ club }) => {
    ...
    return (
      <div className="flex flex-col items-center">
        ...
        >
          ...
          >
            <img
              ...
              onError={(e) => {
                e.target.src =
                  "https://via.placeholder.com/280x256/302122/ffffff?text=" +
                  club.name;
              }}
            />
        ...
        <h3
          className="text-sm sm:text-lg md:text-xl font-semibold mt-2 sm:mt-4 font-poppins text-center"
  ...
  return (
    <div className="w-full overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            theme === "light" ? `url(${backgroundImage})` : "none",
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
      >
        <h2
          className="mb-10 text-3xl md:text-4xl lg:text-5xl font-bold text-center"
          style={{ color: "var(--text-color)" }}
        >
